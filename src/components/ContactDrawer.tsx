    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          <a
            href="tel:6363322889"
            className="flex items-center gap-4 p-4 bg-[#F5E6D3]/10 hover:bg-bg-[#F5E6D3]/20 rounded-xl transition-all"
          >
            <div className="p-3 bg-[#F5E6D3] rounded-full">
              <Phone className="w-5 h-5 text-white" />
            </div>
            <div>
              <div className="text-xs text-gray-500 uppercase">Phone</div>
              <div className="font-semibold text-brand-dark">6363322889</div>
            </div>
          </a>
          ...
          <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-700 leading-relaxed">
               Sarjapur-Bagalur Road,<br />
                SNR 1 Near Vereti Apartment<br />
                Sarjapur, Anekal,<br />
